    ...
    plugins: [
      ...
      VitePWA({
        ...
        includeAssets: [
          ...
          'assets/halwa-logo.svg',
          'assets/halwa-logo-light.svg',
        ...
        manifest: {
          id: '/',
          name: 'Halwa Bakery',
          short_name: 'HalwaBakery',
          description: 'Pesan roti, brownies, dan aneka kue artisan segar dan 100% halal dari Halwa Bakery langsung via WhatsApp.',
          theme_color: '#FAF6EF',
